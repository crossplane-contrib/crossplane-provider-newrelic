...
export TERRAFORM_PROVIDER_VERSION ?= 3.53.0
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-newrelic_v3.53.0
...
xpkg.build.crossplane-provider-newrelic: do.build.images
