...
//nolint:dupl // Similar structure to setupClusterProviderConfig but for namespaced ProviderConfig
...
//nolint:dupl // Similar structure to setupNamespacedProviderConfig but for ClusterProviderConfig
