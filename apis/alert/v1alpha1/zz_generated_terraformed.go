...
func (mg *Destination) GetTerraformResourceType() string {
	return "newrelic_notification_destination"
}

// GetConnectionDetailsMapping for this Destination
func (tr *Destination) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"auth_basic[*].password": "spec.forProvider.authBasic[*].passwordSecretRef", "auth_token[*].token": "spec.forProvider.authToken[*].tokenSecretRef"}
}
