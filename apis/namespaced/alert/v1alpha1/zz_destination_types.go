...
type DestinationInitParameters struct {
	...
	// The type of destination.  One of: EMAIL, SERVICE_NOW, SERVICE_NOW_APP, WEBHOOK, JIRA, MOBILE_PUSH, EVENT_BRIDGE, PAGERDUTY_ACCOUNT_INTEGRATION or PAGERDUTY_SERVICE_INTEGRATION, MICROSOFT_TEAMS, WORKFLOW_AUTOMATION.
...
type SecureURLInitParameters struct {
	...
	SecureSuffixSecretRef v1.LocalSecretKeySelector `json:"secureSuffixSecretRef" tf:"-"`
}
