...
func (mg *AlertCondition) ResolveReferences( // ResolveReferences of this AlertCondition.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("alert.newrelic.m.upbound.io", "v1alpha1", "Policy", "PolicyList")
		if err != nil {
