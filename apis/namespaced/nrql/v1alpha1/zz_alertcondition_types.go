...
type AlertConditionInitParameters struct {
	...
	OutlierConfiguration []OutlierConfigurationInitParameters `json:"outlierConfiguration,omitempty" tf:"outlier_configuration,omitempty"`

	// The ID of the policy where this condition should be used.
	// The ID of the policy where this condition should be used.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/crossplane-provider-newrelic/apis/namespaced/alert/v1alpha1.Policy
	...
	TargetEntity *string `json:"targetEntity,omitempty" tf:"target_entity,omitempty"`
...
type AlertConditionObservation struct {
	...
	// BETA PREVIEW: The configuration block for outlier NRQL alert conditions. See Outlier Configuration below for details.
	// BETA PREVIEW: the `outlier_configuration` field is in limited release and only enabled for preview on a per-account basis. - Defines parameters controlling outlier detection for an `outlier` NRQL condition.
	OutlierConfiguration []OutlierConfigurationObservation `json:"outlierConfiguration,omitempty" tf:"outlier_configuration,omitempty"`
...
type AlertConditionParameters struct {
	...
	// BETA PREVIEW: the `outlier_configuration` field is in limited release and only enabled for preview on a per-account basis. - Defines parameters controlling outlier detection for an `outlier` NRQL condition.
	// +kubebuilder:validation:Optional
	OutlierConfiguration []OutlierConfigurationParameters `json:"outlierConfiguration,omitempty" tf:"outlier_configuration,omitempty"`
...
type DbscanInitParameters struct {

	// The maximum distance between two samples for one to be considered as in the neighborhood of the other. Value must be > 0.
	...
	// NRQL facet attribute used to segment data into groups (e.g. host, region) before running outlier detection. Omit to evaluate all results together.
	...
	EvaluationGroupFacet *string `json:"evaluationGroupFacet,omitempty" tf:"evaluation_group_facet,omitempty"`

	// The number of samples in a neighborhood for a point to be considered as a core point. This includes the point itself. Value must be >= 1.
	...
	MinimumPoints *float64 `json:"minimumPoints,omitempty" tf:"minimum_points,omitempty"`
}

type DbscanObservation struct {
...
type DbscanParameters struct {
	...
	// BETA PREVIEW: the `minimum_points` field is in limited release and only enabled for preview on a per-account basis. - Minimum number of neighboring points needed to form a cluster. Must be >= 1.
	// +kubebuilder:validation:Optional
	MinimumPoints *float64 `json:"minimumPoints" tf:"minimum_points,omitempty"`
}
...
type OutlierConfigurationInitParameters struct {

	// The DBSCAN algorithm configuration block.
	...
	Dbscan []DbscanInitParameters `json:"dbscan,omitempty" tf:"dbscan,omitempty"`
}

type OutlierConfigurationObservation struct {

	// The DBSCAN algorithm configuration block.
	// BETA PREVIEW: the `dbscan` field is in limited release and only enabled for preview on a per-account basis. - Container for DBSCAN settings used to cluster data points and classify noise as outliers. Requires `epsilon` and `minimum_points`; optional `evaluation_group_facet` partitions data before analysis.
	Dbscan []DbscanObservation `json:"dbscan,omitempty" tf:"dbscan,omitempty"`
}

type OutlierConfigurationParameters struct {

	// The DBSCAN algorithm configuration block.
	// BETA PREVIEW: the `dbscan` field is in limited release and only enabled for preview on a per-account basis. - Container for DBSCAN settings used to cluster data points and classify noise as outliers. Requires `epsilon` and `minimum_points`; optional `evaluation_group_facet` partitions data before analysis.
	// +kubebuilder:validation:Optional
	Dbscan []DbscanParameters `json:"dbscan" tf:"dbscan,omitempty"`
}
