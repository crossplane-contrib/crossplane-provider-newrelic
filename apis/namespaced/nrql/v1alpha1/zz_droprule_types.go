...
type DropRuleObservation struct {
	...
	// The ID (GUID) of the corresponding Pipeline Cloud Rule, (migrated upstream by New Relic, in light of the upcoming EOL, as stated in the Deprecation Warning above). This can be used to import the corresponding Pipeline Cloud Rule as a newrelic_pipeline_cloud_rule resource, as explained in our Drop Rules EOL Migration Guide.
	// The GUID of the Pipeline Cloud Rule that will replace the Drop Rule after its EOL on June 30, 2026.
	PipelineCloudRuleEntityID *string `json:"pipelineCloudRuleEntityId,omitempty" tf:"pipeline_cloud_rule_entity_id,omitempty"`
