...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g newrelic.upbound.io -a github.com/crossplane-contrib/crossplane-provider-newrelic/internal/apis -s -p ../apis/cluster/...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g newrelic.m.upbound.io -a github.com/crossplane-contrib/crossplane-provider-newrelic/internal/apis -s -p ../apis/namespaced/...
